...
function PublicCheckout({ id }: { id: string }) {
  ...
  const pixGenerated = method === 'PIX' && ['PENDING', 'OPEN', 'WAITING'].includes(statusUpper) && !!(pixEmv || pixQr);
