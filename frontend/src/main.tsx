...
function qrCodeSrc(value?: string) {
  ...
  return value.startsWith('data:image') || value.startsWith('http') ? value : `data:image/png;base64,${value}`;
}
...
function PublicCheckout({ id }: { id: string }) {
  ...
  const pixEmv = checkout.emv || (checkout.qrCodeBase64?.startsWith('000201') ? checkout.qrCodeBase64 : undefined);
